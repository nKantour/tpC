...
\TODO{Écrire un programme principale qui teste la fonction \texttt{tan(x)}.}
...
\end{cCode}
\TODO{Dans un programme principale tester les instructions suivantes :}
...
\TODO{Dans un programme principale affichez le résultats des instructions suivantes :}
...
\TODO{Reprendre les deux codes précédents.}
